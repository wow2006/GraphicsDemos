...
auto main(int argc, char *argv[]) -> int {
  ...
  glNamedBufferStorage(vbos[positionAttribute], vertices.size() * sizeof(float), vertices.data(), GL_NONE_BIT);
  glNamedBufferStorage(vbos[colorAttribute], colors.size() * sizeof(float), colors.data(), GL_NONE_BIT);
